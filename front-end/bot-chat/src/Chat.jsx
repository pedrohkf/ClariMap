...
const MindMap = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { nodes: parsedNodes, edges: parsedEdges } = convertResponseToNodesAndEdges(data.response);
    ...
    lines.forEach((line, index) => {
      ...
      if (line.startsWith('# ')) {
        ...
        nodes.push({
          ...
          style: { backgroundColor: 'black', color: 'white' }, // Título preto
        });
        ...
        nodes.push({
          ...
          style: { backgroundColor: '#f0f0f0', color: 'black' }, // Subtítulo com fundo claro
        });
        if (parentNode) {
          edges.push({
        ...
        nodes.push({
          ...
          style: { backgroundColor: '#e0e0e0', color: 'black' }, // Subtítulo de nível inferior
        });
        if (parentNode) {
          edges.push({
            id: `e${parentNode}-${nodeId}`,
